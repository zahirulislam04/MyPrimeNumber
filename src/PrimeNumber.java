...
public class PrimeNumber {
	...
	private Boolean isPrimeNumber(int num) {
		...
		for (i = 0; i < primeDivisor.length; i++) {
			//if number has any remainder after dividing by prime divisor then it is a prime number
	...
	public static void main(String[] args) {
		...
		if (counter==0) System.out.println("NO PRIME NUMBERS ARE FOUND");
		else {
			System.out.println("");
			System.out.println("Total " + counter + " prime numbers are found between " + startNumber + " and "  + endNumber);
		}
